function [T_list, R_list, Phi_list,S_list] = Data_collecting(X_target,S,u,r,R,Theta,W,n_target,Phi_dif)
...
for i=1:n_visiting_points
    ...
    if distance_2_point > 0  
        while distance_2_point > 0        
            data_rate = Phi_dif_transmitting_speed(s_agent,X_target,r,R,n_target,Phi_dif);
