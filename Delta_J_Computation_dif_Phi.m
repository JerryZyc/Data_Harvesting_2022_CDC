function [delta_Theta_J,delta_W_J]= Delta_J_Computation_dif_Phi(X_target,r,R,Theta,W,valied_target,Final_Phi_list,Phi_dif)
...
switch Case_Log_Phi
    ...
    case 1    
        for i=1:n
            ...
            Phi_Theta_i = Phi_dif_transmitting_speed(Theta(i),X_target,r,R,n_target,Phi_dif);
